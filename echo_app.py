...
"""
    ...
    components.html(script + modified_svg + """
    <div id="segment_display" style="margin-top:20px; font-size:18px;"></div>
    <div style="display:flex;gap:40px;margin-top:20px;">
        <div id="summary_box" style="flex:0.3;padding:8px;border:2px solid #003366;border-radius:8px;background-color:#f0f4f8;">
            <div id="summary_display" style="font-size:18px;"></div>
        </div>
        <div id="alert_box" style="flex:0.3;padding:8px;border:2px solid #ccc;border-radius:8px;background-color:#fffef6;">
            <div id="alert_display"></div>
        </div>
    </div>
    <button onclick="resetSelections()" style="margin-top:20px;padding:10px 20px;font-size:16px;border:2px solid #ccc;border-radius:8px;background-color:#f9f9f9;color:#003366;font-weight:bold;">Återställ</button>
